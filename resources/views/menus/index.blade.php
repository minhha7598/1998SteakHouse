<x-guest-layout>
    <div class="mb-12 text-center">
        <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 pt-12">
            MENUS</h2>
        <p class="text-xl text-black">Cozy space with many diversified dishes</p>
        <p class="text-xl text-black">Our menu is updated everyday !</p>
    </div>
            ...
            <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg overflow-hidden cursor-pointer">
                ...
                <div class="px-6 pt-6 bg-white">
                    <h4 class="mb-3 font-bold text-xl font-semibold tracking-tight text-green-600 uppercase">
                        {{ $menu->name }}</h4>
                    <p class="leading-normal">{{substr($menu->description, 0,  80)}}</p>
                </div>
