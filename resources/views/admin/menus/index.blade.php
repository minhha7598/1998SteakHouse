<x-admin-layout>
    ...
    <div class="py-12">
        ...
        <p class="text-3xl text-black font-bold">Menu list</p>
            <div class="flex justify-end m-2 p-2">
                <a href="{{ route('admin.menus.create') }}"
                    class="px-4 py-2 bg-green-600 hover:bg-green-500 rounded-lg text-white">New Menu</a>
            </div>
                                ...
                                <tbody>
                                    @foreach ($menus as $menu)
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td
                                                class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <img src="{{ Storage::url($menu->image) }}" class="w-50 h-32 rounded">
                                            </td>
                                            <td
                                                class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                {{ $menu->price }}
                                            ...
                                            <td
                                                ...
                                                <div class="flex space-x-2">
                                                    <a href="{{ route('admin.menus.edit', $menu->id) }}"
                                                        class="px-4 py-2 bg-cyan-400 rounded-lg  text-white">Edit</a>
                                                    <form
