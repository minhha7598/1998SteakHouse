<x-admin-layout>
    ...
    <div class="py-12">
        ...
        <p class="text-3xl text-black font-bold">Update categpry</p>
            ...
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.categories.update', $category->id) }}"
                        ...
                        <button type="submit" class="px-4 py-2 bg-green-600 hover:bg-green-500 rounded-lg text-white rounded-lg text-white">Update</button>
                    </form>
                </div>
