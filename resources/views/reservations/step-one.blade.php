<x-guest-layout>
    <div class="container w-full px-5 py-6 mx-auto">
        <div class="flex items-center min-h-screen bg-slate-800 rounded-lg">
            <!-- <div class="text-xl text-white flex-1">Cozy space with many diversified dishes</div> -->
            <div class="flex-1 h-full max-w-4xl mx-auto bg-white rounded-lg shadow-xl">
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                            <h3 class="mb-4 text-3xl font-bold text-red-500">Make Reservation</h3>

                            <div class="w-full rounded-full">
                                <div
                                    class="w-40 p-1 text-xs font-medium leading-none text-center text-blue-100 bg-slate-800 rounded-full">
                                    Step 1</div>
                            </div>
                            ...
                            <form method="POST" action="{{ route('reservations.store.step.one') }}">
                                ...
                                <div class="mt-6 p-4 flex justify-end">
                                    <button type="submit"
                                        class="px-4 py-2 bg-green-600 hover:bg-green-500 rounded-lg text-white">Next</button>
                                </div>
                            </form>
                        </div>
                    </div>
