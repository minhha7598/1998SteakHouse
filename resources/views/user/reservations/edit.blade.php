<x-user-layout>
    ...
    <div class="py-12">
        ...
        <p class="text-3xl text-black font-bold">Update your reservation</p>
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('user.reservations.update', $reservation->id) }}">
                        ...
                        <button class="px-4 py-2 border border-green-500 rounded-lg text-white">
                            <a class="text-green-600  antialiased"
                            href="{{ route('user.reservations.index') }}">Back</a></button>
                        <button type="submit" 
                            class="px-4 py-2 bg-green-600 hover:bg-green-500 rounded-lg text-white rounded-lg text-white">Update</button>
                        <!-- <div class="mt-6 p-4">
                            <button type="submit"
