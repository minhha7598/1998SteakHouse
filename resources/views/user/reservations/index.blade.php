<x-user-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <p class="text-3xl text-black font-bold">Your reservation list</p>
                            ...
                            <table class="min-w-full">
                                <thead class="bg-gray-50 text-white">
                                    <tr>
                                        ...
                                        <th scope="col" class="py-3 px-6 text-xs font-medium tracking-wider text-left text-white uppercase dark:text-white">
                                            <span >Edit</span>
                                        </th>
                                    </tr>
                                </thead>
                                            ...
                                            <td class="py-4 px-6 text-sm font-medium text-right whitespace-nowrap">
                                                <div class="flex space-x-2">
                                                    <a href="{{ route('user.reservations.edit', $reservation->id) }}"
                                                        class="px-4 py-2 bg-cyan-400 rounded-lg text-white rounded-lg">Edit</a>
                                                    <form
